"""Fake implementation and detection builder for YOLO testing.

This module provides test doubles that mimic the ultralytics YOLO library
interfaces without requiring the actual library or model files.  It also contains
a builder for constructing detection results for unit tests.
"""
...
class DetectionBuilder:
    """Builder for creating test detection data."""
