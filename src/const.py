...
TOPIC_MOTION = "motion"
TOPIC_FRAME_DECODE_MOTION = "/".join([TOPIC_FRAME, TOPIC_DECODE, TOPIC_MOTION,])
TOPIC_FRAME_SCAN_MOTION = "/".join([TOPIC_FRAME, TOPIC_SCAN, TOPIC_MOTION,])
TOPIC_FRAME_PROCESSED_MOTION = "/".join([TOPIC_FRAME, TOPIC_PROCESSED, TOPIC_MOTION,])

TOPIC_OBJECT = "object"
TOPIC_FRAME_DECODE_OBJECT = "/".join([TOPIC_FRAME, TOPIC_DECODE, TOPIC_OBJECT,])
TOPIC_FRAME_SCAN_OBJECT = "/".join([TOPIC_FRAME, TOPIC_SCAN, TOPIC_OBJECT,])
TOPIC_FRAME_PROCESSED_OBJECT = "/".join([TOPIC_FRAME, TOPIC_PROCESSED, TOPIC_OBJECT,])

TOPIC_POST_PROCESSOR = "post_processor"
TOPIC_FACE_RECOGNITION = "face_recognition"
TOPIC_FRAME_SCAN_POSTPROC = "/".join(
    [TOPIC_FRAME, TOPIC_SCAN, TOPIC_POST_PROCESSOR]
)
