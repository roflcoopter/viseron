...
from .const import (
    ...
    CONFIG_MJPEG_DRAW_POST_PROCESSOR_MASK,
    ...
    DEFAULT_MJPEG_DRAW_POST_PROCESSOR_MASK,
    ...
    DEFAULT_THUMBNAIL,
    DEFAULT_URL,
    DEFAULT_USE_LAST_SNAPSHOT_ON_ERROR,
    DEFAULT_USERNAME,
...
MJPEG_STREAM_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(
            CONFIG_MJPEG_DRAW_POST_PROCESSOR_MASK,
            default=DEFAULT_MJPEG_DRAW_POST_PROCESSOR_MASK,
            description=DESC_MJPEG_DRAW_POST_PROCESSOR_MASK,
        ): vol.Coerce(bool),
        vol.Optional(
            CONFIG_MJPEG_DRAW_ZONES,
...
STILL_IMAGE_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(
            CONFIG_USE_LAST_SNAPSHOT_ON_ERROR,
            default=DEFAULT_USE_LAST_SNAPSHOT_ON_ERROR,
            description=DESC_USE_LAST_SNAPSHOT_ON_ERROR,
        ): bool,
    }
)
