    ...
    vol.All(
        {
            ...
            vol.Optional(
                CONFIG_LABEL_REQUIRE_MOTION_OVERLAP,
                default=DEFAULT_LABEL_REQUIRE_MOTION_OVERLAP,
                description=DESC_LABEL_REQUIRE_MOTION_OVERLAP,
            ): bool,
            vol.Optional(
                CONFIG_LABEL_MOTION_OVERLAP_THRESHOLD,
                default=DEFAULT_LABEL_MOTION_OVERLAP_THRESHOLD,
                description=DESC_LABEL_MOTION_OVERLAP_THRESHOLD,
            ): FLOAT_MIN_ZERO_MAX_ONE,
        },
        ensure_min_max,
    )
