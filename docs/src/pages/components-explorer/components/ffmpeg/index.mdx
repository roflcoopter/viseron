...
The tested Jetson Orin Nano uses an explicit backend in a [locally built image](https://github.com/roflcoopter/viseron/blob/dev/docker/jetson-orin/README.md).
