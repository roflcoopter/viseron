    ...
    return HttpResponse.json(
      {
        [today]: {
          "2": {
            ...
            trigger_type: "object",
            trigger_id: null,
            thumbnail_url: "/api/v1/recordings/camera1/2/thumbnail",
        ...
        [yesterday]: {
          "1": {
            ...
            trigger_type: "motion",
            trigger_id: null,
            thumbnail_url: "/api/v1/recordings/camera1/1/thumbnail",
    ...
    return HttpResponse.json(
      {
        [today]: {
          "4": {
            ...
            trigger_type: "object",
            trigger_id: null,
            thumbnail_url: "/api/v1/recordings/camera2/4/thumbnail",
        ...
        [yesterday]: {
          "3": {
            ...
            trigger_type: "motion",
            trigger_id: null,
            thumbnail_url: "/api/v1/recordings/camera2/3/thumbnail",
