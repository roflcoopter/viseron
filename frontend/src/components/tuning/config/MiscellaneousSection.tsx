    ...
    <Box mt={0.5}>
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          ...
          <Tooltip
            title="The Viseron configuration for this component based on the camera you choose. This configuration change has no effect unless you restart Viseron or reload configuration."
            arrow
            placement="top"
          >
            <Help size={16} />
